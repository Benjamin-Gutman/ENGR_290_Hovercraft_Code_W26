...
#define SERVO_LEFT_MAX_PD -90.0f   //USED IN PD
#define SERVO_RIGHT_MAX_PD 90.0f //USED IN PD
#define SERVO_LEFT_MAX -70.0f  //USED IN TURNS
#define SERVO_RIGHT_MAX 75.0f   //USED IN TURNS
#define SERVO_CENTER 0.0f

//Thrust values (placeholders values, not sure what they should be)
#define THRUST_NORMAL 85
#define THRUST_PREPARE 20
#define THRUST_RECENTER 95
#define THRUST_TURN_RIGHT 60
#define THRUST_TURN_LEFT 85
