...
\f0\fs24 \cf0 //Code 1, without timer1 config\
...
#define SERVO_MIN_OCR     125   // 1.0 ms (-90deg)\
//OCR1A = 1.5 x 2500/20 = 188\
#define SERVO_CENTER_OCR  188   // 1.5 ms (center)\
//OCR1A = 2.0 x 2500/20 = 250\
#define SERVO_MAX_OCR     250   // 2.0 ms (+90deg)\
\
